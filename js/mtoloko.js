...
function entrega(retirada, delivery){
    let  tipoEntrega  =  parseInt ( prompt ( `Como deseja receber o pedido? \n1: Retirada no Balcão - Grátis= R$0,00 \ n
2: Entrega/Delivery - R$ 5,00
` ) ) ;
    ...
    if ( tipoEntrega  ==  2 ) {
        let  Delivery  =  {
        celular : prompt ( `${nome}, já que o pedido é para entrega: digite o seu número de celular` ) ,
        rua : prompt ( `${nome}, digite o nome da rua` ) ,
        complemento : prompt ( `${nome}, digite um complemento para o endereço:` ) ,
        numeroCasa : prompt ( `${nome}, digite o numero da casa` ) ,
        bairro : prompt ( `${nome}, digite o nome do seu bairro` ) ,
        pontoDeReferencia : prompt ( `${nome}, digite um ponto de referencia` )
    } ;
}
